...
public class QuestionActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        AnswerList = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, QuestionBank.Module1Questions.get(QuestionNumber).options);
        ...
        AnswerListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == QuestionBank.Module1Questions.get(QuestionNumber).CorrectAnswer){
                    isCorrect = true;
                }
                ...
                QuestionActivity.putExtra("Explination", QuestionBank.Module1Questions.get(QuestionNumber).Explination);
